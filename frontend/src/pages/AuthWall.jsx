...
export default function AuthWall() {
  ...
  const [name, setName] = useState(''); // Only used for Sign Up visually right now
  ...
  const handleAuth = async (e) => {
    ...
    try {
      if (isSignUp) {
        ...
        // Note: You can optionally update the user's profile with 'name' here using updateProfile
      } else {
